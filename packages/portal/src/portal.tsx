import { useForceUpdate, useSafeLayoutEffect } from "@cake-ui/hooks"
import { isBrowser, __DEV__ } from "@cake-ui/utils"
...
const Container: React.FC<{ zIndex: number }> = (props) => (
  <div
    ...
    style={{
      ...
      // @see https://github.com/cake-ui/cake-ui/issues/3201
    }}
  >
    {props.children}
  </div>
