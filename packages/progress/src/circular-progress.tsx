import { chakra, SystemStyleObject, HTMLChakraProps } from "@cake-ui/system"
import { isUndefined, StringOrNumber, __DEV__ } from "@cake-ui/utils"
    ...
    >
      <Shape size={size} isIndeterminate={isIndeterminate}>
        ...
        <Circle
           ...
           * @see Issue https://github.com/cake-ui/cake-ui/issues/3754
           */
